/*
 * Twitter Badge on the fly hosted on Google App Engine @2013 17:17:18
 * @thinkphp http://thinkphp.ro 
 * MIT License
 */
...
/* configurations */
      ...
      var config = {
                    ...
                    styles: {
                          ...
                          'black': 'http://ztwitterbadge.appspot.com/css/skin-black.css',

                          'blue': 'http://ztwitterbadge.appspot.com/css/skin-blue.css'
                    } 
...
/* private methods */
      ...
      function init(o) {
          ...
          if(type === 'friends') {
              ...
              var url = 'http://twitter.com/statuses/friends_timeline/'+ username +'.json?callback=twitterbadge.show2&count=' + amount;

          } else if(type === 'user'){

              var url = 'http://api.twitter.com/1/statuses/user_timeline/'+ username +'.json?callback=twitterbadge.show&count=' + amount;

          }  else if(type === 'search'){ 

              var url = 'http://search.twitter.com/search.json?q='+ search +'&callback=twitterbadge.show3&count=' + amount;
          } 
